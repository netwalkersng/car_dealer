...
--
-- Table structure for table `db_tabprefixcarbiz_emailtmpl`
--

DROP TABLE IF EXISTS `db_tabprefixcarbiz_emailtmpl`;
CREATE TABLE `db_tabprefixcarbiz_emailtmpl` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `db_tabprefixcarbiz_emailtmpl`
--

INSERT INTO `db_tabprefixcarbiz_emailtmpl` (`id`, `email_name`, `values`, `status`) VALUES
...
--
-- Indexes for table `db_tabprefixcarbiz_emailtmpl`
--
ALTER TABLE `db_tabprefixcarbiz_emailtmpl`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `db_tabprefixcarbiz_emailtmpl`
--
ALTER TABLE `db_tabprefixcarbiz_emailtmpl`
